...
class FetchConfiguration private constructor(val appContext: Context,
    ...
    * */
    ...
    class Builder(context: Context) {
         ...
         * @see id.andtree.reqcore.Downloader
         * @see id.andtree.req.HttpUrlConnectionDownloader
         * @see id.andtree.reqhttp.OkHttpDownloader
         ...
         * @see id.andtree.req.Downloader
         * @see id.andtree.req.FileServerDownloader
         ...
         * @see id.andtree.req.FetchListener.onProgress is called for each
