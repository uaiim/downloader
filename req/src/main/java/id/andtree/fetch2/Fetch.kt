...
import id.andtree.req.exception.FetchException
import id.andtree.req.fetch.FetchImpl
import id.andtree.req.fetch.FetchModulesBuilder
import id.andtree.req.util.DEFAULT_ENABLE_LISTENER_NOTIFY_ON_ATTACHED
import id.andtree.req.util.DEFAULT_ENABLE_LISTENER_NOTIFY_ON_REQUEST_UPDATED
...
import id.andtree.reqcore.Func
import id.andtree.reqcore.Func2
import id.andtree.reqcore.GLOBAL_FETCH_CONFIGURATION_NOT_SET
...
interface Fetch {
     ...
     * @see id.andtree.req.FetchConfiguration
     * */
     ...
     * @see id.andtree.req.Request for more details.
     ...
     * Use id.andtree.req.NetworkType.GLOBAL_OFF to disable the global network preference.
     * The default value is id.andtree.req.NetworkType.GLOBAL_OFF
     * @see id.andtree.req.NetworkType
