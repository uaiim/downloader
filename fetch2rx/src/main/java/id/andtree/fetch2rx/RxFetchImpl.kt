...
import id.andtree.fetch2.fetch.FetchHandler
import id.andtree.fetch2.fetch.FetchModulesBuilder.Modules
import id.andtree.fetch2.fetch.ListenerCoordinator
import id.andtree.fetch2.Status
import id.andtree.fetch2.database.FetchDatabaseManagerWrapper
import id.andtree.fetch2.util.ActiveDownloadInfo
import id.andtree.fetch2.util.DEFAULT_ENABLE_LISTENER_AUTOSTART_ON_ATTACHED
import id.andtree.fetch2.util.DEFAULT_ENABLE_LISTENER_NOTIFY_ON_ATTACHED
import id.andtree.fetch2.util.toDownloadInfo
import id.andtree.fetch2core.*
import id.andtree.fetch2rx.util.toConvertible
...
open class RxFetchImpl(override val namespace: String,
    ...
    override fun awaitFinishOrTimeout(allowTimeInMilliseconds: Long) {
        id.andtree.fetch2.util.awaitFinishOrTimeout(allowTimeInMilliseconds, fetchHandler)
    }
