...
import id.andtree.req.fetch.FetchHandler
import id.andtree.req.fetch.FetchModulesBuilder.Modules
import id.andtree.req.fetch.ListenerCoordinator
import id.andtree.req.Status
import id.andtree.req.database.FetchDatabaseManagerWrapper
import id.andtree.req.util.ActiveDownloadInfo
import id.andtree.req.util.DEFAULT_ENABLE_LISTENER_AUTOSTART_ON_ATTACHED
import id.andtree.req.util.DEFAULT_ENABLE_LISTENER_NOTIFY_ON_ATTACHED
import id.andtree.req.util.toDownloadInfo
import id.andtree.reqcore.*
import id.andtree.reqrx.util.toConvertible
...
open class RxFetchImpl(override val namespace: String,
    ...
    override fun awaitFinishOrTimeout(allowTimeInMilliseconds: Long) {
        id.andtree.req.util.awaitFinishOrTimeout(allowTimeInMilliseconds, fetchHandler)
    }
