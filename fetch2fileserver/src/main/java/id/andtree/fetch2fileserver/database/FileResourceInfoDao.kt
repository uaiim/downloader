package id.andtree.fetch2fileserver.database

import androidx.room.*
import id.andtree.fetch2fileserver.database.FileResourceInfoDatabase.Companion.COLUMN_ID
import id.andtree.fetch2fileserver.database.FileResourceInfoDatabase.Companion.COLUMN_NAME
import id.andtree.fetch2fileserver.database.FileResourceInfoDatabase.Companion.TABLE_NAME
