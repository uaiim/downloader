package id.andtree.fetch2core.server

import id.andtree.fetch2core.Extras
import id.andtree.fetch2core.server.FileResponse.CREATOR.FIELD_CONNECTION
import id.andtree.fetch2core.server.FileResponse.CREATOR.FIELD_CONTENT_LENGTH
import id.andtree.fetch2core.server.FileResponse.CREATOR.FIELD_DATE
import id.andtree.fetch2core.server.FileResponse.CREATOR.FIELD_MD5
import id.andtree.fetch2core.server.FileResponse.CREATOR.FIELD_SESSION_ID
import id.andtree.fetch2core.server.FileResponse.CREATOR.FIELD_STATUS
import id.andtree.fetch2core.server.FileResponse.CREATOR.FIELD_TYPE
