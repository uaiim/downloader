package id.andtree.fetch2.fetch

import android.os.Handler
import android.os.Looper
import id.andtree.fetch2.Download
import id.andtree.fetch2.FetchConfiguration
import id.andtree.fetch2.database.*
import id.andtree.fetch2.downloader.DownloadManager
import id.andtree.fetch2.downloader.DownloadManagerCoordinator
import id.andtree.fetch2.downloader.DownloadManagerImpl
import id.andtree.fetch2.helper.DownloadInfoUpdater
import id.andtree.fetch2.helper.PriorityListProcessor
import id.andtree.fetch2.helper.PriorityListProcessorImpl
import id.andtree.fetch2.provider.DownloadProvider
import id.andtree.fetch2.provider.GroupInfoProvider
import id.andtree.fetch2.provider.NetworkInfoProvider
import id.andtree.fetch2.util.deleteAllInFolderForId
import id.andtree.fetch2.util.getRequestForDownload
import id.andtree.fetch2core.DefaultStorageResolver
import id.andtree.fetch2core.HandlerWrapper
import id.andtree.fetch2core.getFileTempDir
