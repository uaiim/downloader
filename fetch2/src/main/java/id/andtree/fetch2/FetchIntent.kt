...
const val ACTION_QUEUE_BACKOFF_RESET = "id.andtree.fetch2.action.QUEUE_BACKOFF_RESET"
...
const val EXTRA_NAMESPACE = "id.andtree.fetch2.extra.NAMESPACE"
const val EXTRA_DOWNLOAD_ID = "id.andtree.fetch2.extra.DOWNLOAD_ID"
const val EXTRA_DOWNLOAD_NOTIFICATIONS = "con.tonyodev.fetch2.extra.DOWNLOAD_NOTIFICATIONS"
const val EXTRA_NOTIFICATION_ID = "id.andtree.fetch2.extra.NOTIFICATION_ID"
const val EXTRA_NOTIFICATION_GROUP_ID = "id.andtree.fetch2.extra.NOTIFICATION_GROUP_ID"
const val EXTRA_ACTION_TYPE = "id.andtree.fetch2.extra.ACTION_TYPE"
const val EXTRA_GROUP_ACTION = "id.andtree.fetch2.extra.GROUP_ACTION"
