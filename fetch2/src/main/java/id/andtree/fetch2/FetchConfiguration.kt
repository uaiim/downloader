...
class FetchConfiguration private constructor(val appContext: Context,
    ...
    * */
    ...
    class Builder(context: Context) {
         ...
         * @see id.andtree.fetch2core.Downloader
         * @see id.andtree.fetch2.HttpUrlConnectionDownloader
         * @see id.andtree.fetch2okhttp.OkHttpDownloader
         ...
         * @see id.andtree.fetch2.Downloader
         * @see id.andtree.fetch2.FileServerDownloader
         ...
         * @see id.andtree.fetch2.FetchListener.onProgress is called for each
