package id.andtree.fetch2.database

import androidx.room.*
import id.andtree.fetch2.Status
import id.andtree.fetch2.database.DownloadDatabase.Companion.COLUMN_CREATED
import id.andtree.fetch2.database.DownloadDatabase.Companion.COLUMN_FILE
import id.andtree.fetch2.database.DownloadDatabase.Companion.COLUMN_GROUP
import id.andtree.fetch2.database.DownloadDatabase.Companion.COLUMN_ID
import id.andtree.fetch2.database.DownloadDatabase.Companion.COLUMN_IDENTIFIER
import id.andtree.fetch2.database.DownloadDatabase.Companion.COLUMN_PRIORITY
import id.andtree.fetch2.database.DownloadDatabase.Companion.COLUMN_STATUS
import id.andtree.fetch2.database.DownloadDatabase.Companion.COLUMN_TAG
import id.andtree.fetch2.database.DownloadDatabase.Companion.TABLE_NAME
