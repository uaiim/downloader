package id.andtree.fetch2

import android.annotation.SuppressLint
import id.andtree.fetch2.database.DownloadInfo
import id.andtree.fetch2.exception.FetchException
import id.andtree.fetch2.fetch.FetchImpl
import id.andtree.fetch2.fetch.FetchModulesBuilder
import id.andtree.fetch2.util.DEFAULT_ENABLE_LISTENER_NOTIFY_ON_ATTACHED
import id.andtree.fetch2.util.DEFAULT_ENABLE_LISTENER_NOTIFY_ON_REQUEST_UPDATED
import id.andtree.fetch2core.DownloadBlock
import id.andtree.fetch2core.Downloader
import id.andtree.fetch2core.Extras
import id.andtree.fetch2core.FetchObserver
import id.andtree.fetch2core.FileResource
import id.andtree.fetch2core.Func
import id.andtree.fetch2core.Func2
import id.andtree.fetch2core.GLOBAL_FETCH_CONFIGURATION_NOT_SET
 ...
 * @see <a href="https://github.com/uaiim/downloader</a>
 * */
interface Fetch {
     ...
     * @see id.andtree.fetch2.FetchConfiguration
     * */
     ...
     * @see id.andtree.fetch2.Request for more details.
     ...
     * Use id.andtree.fetch2.NetworkType.GLOBAL_OFF to disable the global network preference.
     * The default value is id.andtree.fetch2.NetworkType.GLOBAL_OFF
     * @see id.andtree.fetch2.NetworkType
