...
import id.andtree.fetch2.DownloadNotification.ActionType.*
import id.andtree.fetch2.util.DEFAULT_NOTIFICATION_TIMEOUT_AFTER
import id.andtree.fetch2.util.DEFAULT_NOTIFICATION_TIMEOUT_AFTER_RESET
import id.andtree.fetch2.util.onDownloadNotificationActionTriggered
