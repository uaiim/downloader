...
import id.andtree.fetch2.AbstractFetchListener;
import id.andtree.fetch2.Download;
import id.andtree.fetch2.Error;
import id.andtree.fetch2core.Downloader;
import id.andtree.fetch2.Fetch;
import id.andtree.fetch2.FetchConfiguration;
import id.andtree.fetch2.FetchListener;
import id.andtree.fetch2.Priority;
import id.andtree.fetch2.Request;
import id.andtree.fetch2core.FetchCoreUtils;
import id.andtree.fetch2core.FileResource;
import id.andtree.fetch2core.MutableExtras;
import id.andtree.fetch2fileserver.FetchFileServer;
import id.andtree.fetch2.FetchFileServerDownloader;
import id.andtree.fetch2core.FetchFileServerUriBuilder;
