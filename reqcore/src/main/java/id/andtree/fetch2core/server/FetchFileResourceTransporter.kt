package id.andtree.reqcore.server

import id.andtree.reqcore.Extras
import id.andtree.reqcore.server.FileResponse.CREATOR.FIELD_CONNECTION
import id.andtree.reqcore.server.FileResponse.CREATOR.FIELD_CONTENT_LENGTH
import id.andtree.reqcore.server.FileResponse.CREATOR.FIELD_DATE
import id.andtree.reqcore.server.FileResponse.CREATOR.FIELD_MD5
import id.andtree.reqcore.server.FileResponse.CREATOR.FIELD_SESSION_ID
import id.andtree.reqcore.server.FileResponse.CREATOR.FIELD_STATUS
import id.andtree.reqcore.server.FileResponse.CREATOR.FIELD_TYPE
